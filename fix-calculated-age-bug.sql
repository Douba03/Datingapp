-- Fix the calculated_age bug in the function
-- Run this in Supabase SQL Editor

-- Drop the existing function
DROP FUNCTION IF EXISTS create_complete_profile;

-- Recreate with fixed calculated_age logic
...
BEGIN
  ...
  -- Calculate age (fixed - moved outside nested DECLARE)
...
SELECT '✅ Fixed function created!' as message;
SELECT 'The calculated_age bug is fixed!' as status;
